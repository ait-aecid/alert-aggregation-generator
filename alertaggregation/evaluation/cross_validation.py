...
from alertaggregation.preprocessing import read_input
from alertaggregation.clustering import time_delta_group
from alertaggregation.similarity import similarity
from alertaggregation.merging.objects import MetaAlert, MetaAlertManager, KnowledgeBase
...
with open('data/out/cross_validation/sim_list.txt', 'w') as sim_out, open('data/out/cross_validation/cross_corr.txt', 'w') as cross_corr, open('data/out/cross_validation/reductions.txt', 'w') as reduct:
  ...
  for threshold in thresholds:
    ...
    similarities_matrix = {} # similarities_matrix[<actual_class>][<predicted_class>] = [sim_1, sim_2, alertaggregation..]
    for lab in labels:
